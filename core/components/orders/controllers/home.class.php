...
class ordersHomeManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/windows.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/window.admin.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/window.manager.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/window.manager-line.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/window.avtovyvoz1.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/window.avtovyvoz2.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/items/windows/window.tamozhnya.js');
        ...
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/agents2/agents2.grid.js');
        $this->addJavascript($this->orders->config['jsUrl'] . 'mgr/widgets/agents2/agents2.windows.js');
