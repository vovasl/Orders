...
class ordersCompanyWarehouseUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_company_warehouse_err_ns');
        }
...
return 'ordersCompanyWarehouseUpdateProcessor';
