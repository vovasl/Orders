...
class ordersStationTrainArriveUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_station_train_arrive_err_ns');
        }
...
return 'ordersStationTrainArriveUpdateProcessor';
