...
class ordersPortDepartureUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_port_departure_err_ns');
        }
...
return 'ordersPortDepartureUpdateProcessor';
