...
class ordersAgentRailwayUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_agent_railway_err_ns');
        }
...
return 'ordersAgentRailwayUpdateProcessor';
