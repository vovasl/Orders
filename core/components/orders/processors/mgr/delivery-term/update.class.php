...
class ordersDeliveryTermUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_delivery_term_err_ns');
        }
...
return 'ordersDeliveryTermUpdateProcessor';
