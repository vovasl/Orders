...
class ordersTemplateUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_template_err_ns');
        }
...
return 'ordersTemplateUpdateProcessor';
