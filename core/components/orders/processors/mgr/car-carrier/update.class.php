...
class ordersCarCarrierUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_car_carrier_err_ns');
        }
...
return 'ordersCarCarrierUpdateProcessor';
