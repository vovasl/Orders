...
class ordersPortArriveUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_port_arrive_err_ns');
        }
...
return 'ordersPortArriveUpdateProcessor';
