...
class ordersForwarderUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_forwarder_err_ns');
        }
...
return 'ordersForwarderUpdateProcessor';
