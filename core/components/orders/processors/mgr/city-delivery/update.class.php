...
class ordersCityDeliveryUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('orders_city_delivery_err_ns');
        }
...
return 'ordersCityDeliveryUpdateProcessor';
