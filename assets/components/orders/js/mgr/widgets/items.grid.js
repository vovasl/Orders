...
Ext.extend(orders.grid.Items, MODx.grid.Grid, {
    ...
    allFields: function () {
        ...
        fields = {
            ...
            id: {width: 34},
            release: {width: 29, renderer: orders.utils.renderBoolean, editor: {xtype: 'xcheckbox'}},
            release_date: {
                width: 70,
    ...
    getColumns: function () {
        ...
        for (var i = 0; i < fields.length; i++) {
            ...
            if (all[field]) {
                ...
                if(orders.config['orders_manager'] && !orders.config['orders_item_manager_edit_fields'].includes(field)) {
    ...
    getTopBar: function () {
        var createItem = {
            text: '<i class="icon icon-plus"></i>&nbsp;' + _('orders_item_create'),
        ...
        if(orders.config['orders_perm_create_button']){
