...
Ext.extend(orders.grid.Items, MODx.grid.Grid, {
    ...
    allFields: function () {
        ...
        fields = {
            ...
            pstat: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            exwstat: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            frstat: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_1: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_2: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_3: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_4: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_5: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_6: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            prochstat_7: {width: 65, editor: {xtype: 'orders-combo-yes-no', renderer: true}},
            tpusdval: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            pstatval: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval1: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval2: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval3: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval4: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval5: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval6: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            prval7: {width: 85, editor: {xtype: 'orders-combo-currency', renderer: true}},
            stavrubsum: {width: 74, editor: {xtype: 'textfield'}},
            tpusdsum: {width: 74, editor: {xtype: 'textfield'}},
            pstatsum: {width: 74, editor: {xtype: 'textfield'}},
            exwstatsum: {width: 74, editor: {xtype: 'textfield'}},
            frusdsum: {width: 74, editor: {xtype: 'textfield'}},
            tautosum: {width: 74, editor: {xtype: 'textfield'}},
            prsum1: {width: 74, editor: {xtype: 'textfield'}},
            prsum2: {width: 74, editor: {xtype: 'textfield'}},
            prsum3: {width: 74, editor: {xtype: 'textfield'}},
            prsum4: {width: 74, editor: {xtype: 'textfield'}},
            prsum5: {width: 74, editor: {xtype: 'textfield'}},
            prsum6: {width: 74, editor: {xtype: 'textfield'}},
            prsum7: {width: 74, editor: {xtype: 'textfield'}},
            stavrubpr: {width: 125, editor: {xtype: 'textarea'}},
            tpusdpr: {width: 125, editor: {xtype: 'textarea'}},
            pstatpr: {width: 125, editor: {xtype: 'textarea'}},
            exwstatpr: {width: 125, editor: {xtype: 'textarea'}},
            frusdpr: {width: 125, editor: {xtype: 'textarea'}},
            stautopr: {width: 125, editor: {xtype: 'textarea'}},
            pr1pr: {width: 125, editor: {xtype: 'textarea'}},
            pr2pr: {width: 125, editor: {xtype: 'textarea'}},
            pr3pr: {width: 125, editor: {xtype: 'textarea'}},
            pr4pr: {width: 125, editor: {xtype: 'textarea'}},
            pr5pr: {width: 125, editor: {xtype: 'textarea'}},
            pr6pr: {width: 125, editor: {xtype: 'textarea'}},
            pr7pr: {width: 125, editor: {xtype: 'textarea'}},
            stavrub: {width: 74},
            tpusd: {width: 74, editor: {xtype: 'textfield'}},
            pstatusd: {width: 74, editor: {xtype: 'textfield'}},
            exwstatusd: {width: 74},
            frusd: {width: 74},
            stauto: {width: 74},
            pr1: {width: 74},
